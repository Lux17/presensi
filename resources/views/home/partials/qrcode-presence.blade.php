<div>
    ...
    {{-- jika tidak menggunakan qrcode (button) dan anggota saat ini tidak menekan tombol izin --}}
    ...
    {{-- jika absen pulang sudah dimulai, dan anggota sudah absen masuk dan belum absen pulang --}}
